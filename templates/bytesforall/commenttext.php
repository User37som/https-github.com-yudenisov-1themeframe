<div class="infocontainer-head">
	<h2 style="float:left;padding-right:30px">Comment Section <strong>Comment Text Bits</strong></h2>
	<a class="moreinfolink" id="commenttextinfo" href="#">Show/Hide More Info</a>
</div>

<div id="multisettingpage" style="padding:20px;font-size: 13px" >
	<div id="commenttextinfo-container" class="infocontainer">
	...
	<textarea style="width:100%;height:400px" name="commenttext" id="commenttext"><?php echo htmlspecialchars($thfr_css['commenttext']); ?></textarea>
	</div><br/>
	<a href="#" id="save-commenttext" class="save-button">Save</a>
